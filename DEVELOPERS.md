...
Windows is not part of the standalone release matrix. Windows users should use the npm-published CLI. Decision and restore criteria are in [ADR-003: Retire Windows SEA and CI](docs/features/architecture/adr-003-retire-windows-sea-ci.md).
