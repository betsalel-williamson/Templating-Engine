...
Windows is not part of the standalone release matrix. Windows users should use the npm-published CLI. Decision and restore criteria are in [ADR-002: Retire Windows SEA and CI](../features/architecture/adr-002-retire-windows-sea-ci.md).
