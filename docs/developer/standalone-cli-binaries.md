...
Windows is not part of the standalone release matrix. Windows users should use the npm-published CLI. Decision, restore criteria, and pointers to the prior Windows SEA/CI implementation are in [ADR-003: Retire Windows SEA and CI](../features/architecture/adr-003-retire-windows-sea-ci.md).
