...
- **Distribution:** We use Node.js's Single Executable Application (SEA) feature for dependency-free Linux and macOS CLI binaries. Windows users install the CLI via npm. See [ADR-002: Retire Windows SEA and CI](./adr-002-retire-windows-sea-ci.md).
